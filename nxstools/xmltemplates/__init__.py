...
moduleTemplateFiles = {
    ...
    'pilcfvds': ['pilcfvds.xml',
                 'pilcfvds_countervds.ds.xml',
                 'pilcfvds_encoder1vds.ds.xml',
                 'pilcfvds_encoder2vds.ds.xml',
                 'pilcfvds_encoder3vds.ds.xml',
                 'pilcfvds_encoder4vds.ds.xml',
                 'pilcfvds_encoder5vds.ds.xml'],
    ...
    'limaccdsvds': ['limaccdsvds.xml',
                    ...
                    'limaccdsvds_filestartnum_cb.ds.xml'],
    'limaccdovds': ['limaccdovds.xml',
                    'limaccdovds.ds.xml',
                    'limaccdovds_xpixelsize.ds.xml',
                    'limaccdovds_ypixelsize.ds.xml',
                    'limaccdovds_description.ds.xml',
                    'limaccdovds_filestartnum_cb.ds.xml'],
    'limaccdevds': ['limaccdevds.xml',
                    'limaccdevds.ds.xml',
                    'limaccdevds_xpixelsize.ds.xml',
                    'limaccdevds_ypixelsize.ds.xml',
                    'limaccdevds_description.ds.xml',
                    'limaccdevds_filestartnum_cb.ds.xml'],
    'pco': ['pco.xml',
            'pco_postrun.ds.xml',
